...
MainDialog::MainDialog(QWidget *parent) : QDialog(parent) {
  ...
  */
  ...
  linkButtonLayout->addWidget(nextTargetButton);
  linkButtonLayout->addWidget(prevTargetButton);
  ...
  linkButtonLayout->addWidget(nextSourceButton);
  linkButtonLayout->addWidget(prevSourceButton);
